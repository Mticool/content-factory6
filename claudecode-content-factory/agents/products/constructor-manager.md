...
|-------------|---------------------|
| Новый хук/пример | `skills/{skill}/` |
| Улучшение промпта | `skills/{skill}/SKILL.md` |
...
2. Файл: skills/threads/threads-hooks.md
3. Формирую:
...
cp -r ~/your-workspace/skills/* \
      ~/your-workspace/konstruktor-fabriki/content-factory-template/skills/
...
# Скиллы
ls konstruktor-fabriki/content-factory-template/skills/
```
